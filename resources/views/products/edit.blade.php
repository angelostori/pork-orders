    ...
    <div class="bg-light p-4 rounded shadow-sm">
        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3 row align-items-center">
                ...
                <div class="col-6">
                    <input type="text" class="form-control form-control-lg" id="price" name="price" value="{{ $product->price }}">
                </div>
            ...
            <div class="mb-3 row align-items-center">
                ...
                <div class="col-8">
                    <textarea class="form-control form-control-lg" id="description" name="description" rows="6">{{ $product->description }}</textarea>
                </div>
            </div>
